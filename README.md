...
### `tag`：  给S3中的对象打标签，最多打64个标签，键值对格式 `key:value` 用`:`分隔，多个键值对用`,`分隔，最长256字节（256个ascii字符或者85个中文字符）
...
``` 
	...
	export S3UPLOADER_MAXSIZE_MB=4096
...
```
	...
	export ALPHA_S3UPLOADER_MAXSIZE_MB=4096
